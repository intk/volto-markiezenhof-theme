...
2. Go to your repository at [github.com/intk/markiezenhof](https://github.com/github.com/intk/markiezenhof).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `www.markiezenhof.nl` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | www.markiezenhof.nl | The hostname or IP address of your Docker Swarm manager. |
...
- [Backend Tests Workflow](https://github.com/github.com/intk/markiezenhof/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/github.com/intk/markiezenhof/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`github.com/intk/markiezenhof-backend`) and Frontend (`github.com/intk/markiezenhof-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of www.markiezenhof.nl](https://github.com/github.com/intk/markiezenhof/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/www.markiezenhof.nl.yml` stack.
