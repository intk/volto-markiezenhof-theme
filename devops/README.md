...
```
DEPLOY_ENV=prod
DEPLOY_HOST=www.markiezenhof.nl
DEPLOY_PORT=22
DEPLOY_USER=plone
...
Deploy the stack defined in `devops/stacks/www.markiezenhof.nl.yml` to the remote server with:
